  ...
  return (
    <div className="bg-white dark:bg-[#141824] rounded-xl p-5 border border-slate-200 dark:border-[#1e2433] shadow-lg transition-colors duration-300">
      ...
      <div className="space-y-3">
        ...
        <div
          key={pool.id}
          className="flex items-center justify-between p-3 rounded-lg bg-slate-100 dark:bg-[#0a0e1a]/50 border border-slate-200 dark:border-[#1e2433] hover:border-[#0033ad]/30 transition-colors">
            ...
            <div className="text-right">
              ...
              <div className="text-[10px] text-slate-700 dark:text-slate-600">APY</div>
            </div>
          </div>
        )}
      </div>
