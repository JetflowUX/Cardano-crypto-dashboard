  ...
  return (
    <div className="bg-white dark:bg-[#141824] rounded-xl p-5 border border-slate-200 dark:border-[#1e2433] shadow-lg transition-colors duration-300">
      ...
      <div className="relative flex items-center justify-center py-2">
        ...
        {/* Indicator */}
        <div
          className="absolute w-4 h-4 bg-white dark:bg-white border-2 border-slate-200 dark:border-[#141824] rounded-full shadow-lg transform -translate-y-1/2 top-1/2"
          style={{
            left: '75%'
          }} />
      ...
      <p className="text-[10px] text-slate-700 dark:text-slate-500 text-center mt-2">
