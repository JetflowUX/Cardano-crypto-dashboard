...
export function PortfolioSummary() {
  return (
    <div className="bg-gradient-to-br from-[#141824] to-[#0a0e1a] rounded-2xl p-6 border border-[#1e2433] shadow-xl hover:shadow-[#0033ad]/10 transition-all duration-300">
      ...
      <div className="mb-8">
        <div className="flex items-baseline gap-2">
          <span className="text-4xl font-bold text-white tracking-tight">$12,458.32</span>
      ...
      <div className="space-y-4">
        ...
        <div className="flex h-3 w-full rounded-full overflow-hidden bg-[#0a0e1a]">
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          <div className="flex items-center gap-2 p-2 rounded-lg bg-[#0a0e1a]/50 border border-[#1e2433]">
            <div className="w-2 h-2 rounded-full bg-[#0033ad]" />
            <span className="text-xs text-slate-300">ADA</span>
            <span className="text-xs text-slate-500 ml-auto">65%</span>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg bg-[#0a0e1a]/50 border border-[#1e2433]">
            <div className="w-2 h-2 rounded-full bg-purple-500" />
            <span className="text-xs text-slate-300">SNEK</span>
            <span className="text-xs text-slate-500 ml-auto">20%</span>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg bg-[#0a0e1a]/50 border border-[#1e2433]">
          ...
          <div className="flex items-center gap-2 p-2 rounded-lg bg-[#0a0e1a]/50 border border-[#1e2433]">
            ...
            <span className="text-xs text-slate-500 ml-auto">5%</span>
          </div>
        </div>
      </div>
    </div>
